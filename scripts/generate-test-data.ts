...
const serviceChargesPath = path.join(__dirname, "../packages/test-data/service-charges.json")
const residentsPath = path.join(__dirname, "../packages/test-data/residents.json")
